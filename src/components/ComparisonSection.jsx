    ...
    features: [
      {
        ...
        tiers: {
          Zipcar: false,
          Turo: false,
          Vroom: "Delivered to your doorstep",
        },
      },
      {
        name: "Different Pickup and Dropoff",
        tiers: { Zipcar: false, Turo: false, Vroom: true },
      },
      {
        name: "Pre and Post Vehicle Inspection",
        tiers: { Zipcar: false, Turo: false, Vroom: true },
      },
      {
        name: "Convallis.",
        tiers: { Zipcar: true, Turo: true, Vroom: true },
      },
    ],
  },
  {
